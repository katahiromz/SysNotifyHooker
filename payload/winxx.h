...
/****************************************************************************/
/* _countof --- number of elements in an array */
...
/****************************************************************************/
/* LOLONG, HILONG, MAKELONGLONG --- manipulates 64-bit integer values */

#ifdef LOLONG
    #define LOLONG(dwl)     ((ULONG)(ULONG_PTR)(dwl))
#endif
#ifdef HILONG
    #define HILONG(dwl)     ((ULONG)(((ULONG_PTR)(dwl)) >> 32))
#endif
#ifndef MAKELONGLONG
    #define MAKELONGLONG(dwLow,dwHigh) \
        (((ULONG)(ULONG_PTR)(dwLow)) | (((ULONGLONG)(ULONG)(ULONG_PTR)(dwHigh)) << 32))
#endif
...
#define FORWARD_WM_INPUTLANGCHANGEREQUEST(hwnd, bFlag, hKL, fn) \
    (void)((fn)((hwnd), WM_INPUTLANGCHANGEREQUEST, (WPARAM)(BOOL)(bFlag), (LPARAM)(HKL)(hKL)), 0L)
#endif
...
#define FORWARD_WM_INPUTLANGCHANGE(hwnd, dwCharSet, hKL, fn) \
    (void)((fn)((hwnd), WM_INPUTLANGCHANGE, (WPARAM)(DWORD)(dwCharSet), (LPARAM)(HKL)(hKL)), 0L)
#endif
...
#define FORWARD_WM_NOTIFYFORMAT(hwnd, hwndTarget, nCommand, fn) \
    (INT)(fn)((hwnd), WM_NOTIFYFORMAT, (WPARAM)(HWND)(hwndTarget), (LPARAM)(INT)(nCommand))
#endif
...
#define FORWARD_WM_STYLECHANGING(hwnd, nStyleType, lpStyleStruct, fn) \
    (void)((fn)((hwnd), WM_STYLECHANGING, (WPARAM)(UINT)(nStyleType), (LPARAM)(LPSTYLESTRUCT)(lpStyleStruct)), 0L)
#endif
...
#define FORWARD_WM_STYLECHANGED(hwnd, nStyleType, lpStyleStruct, fn) \
    (void)((fn)((hwnd), WM_STYLECHANGED, (WPARAM)(UINT)(nStyleType), (LPARAM)(const STYLESTRUCT *)(lpStyleStruct)), 0L)
#endif
...
#define HANDLE_WM_NCXBUTTONDOWN(hwnd, wParam, lParam, fn) \
    (LRESULT)((fn)((hwnd), FALSE, GET_NCHITTEST_WPARAM(wParam), GET_XBUTTON_WPARAM(wParam), GET_X_LPARAM(lParam), GET_Y_LPARAM(lParam)), TRUE)
#define HANDLE_WM_NCXBUTTONDBLCLK(hwnd, wParam, lParam, fn) \
    (LRESULT)((fn)((hwnd), TRUE, GET_NCHITTEST_WPARAM(wParam), GET_XBUTTON_WPARAM(wParam), GET_X_LPARAM(lParam), GET_Y_LPARAM(lParam)), TRUE)
#define FORWARD_WM_NCXBUTTONDOWN(hwnd, fDoubleClick, nHitTest, fwButton, xPos, yPos, fn) \
    (void)((fn)((hwnd), ((fDoubleClick) ? WM_NCXBUTTONDBLCLK : WM_NCXBUTTONDOWN), MAKEWPARAM((nHitTest), (fwButton)), MAKELPARAM((xPos), (yPos))), 0L)
#endif
...
#define HANDLE_WM_NCXBUTTONUP(hwnd, wParam, lParam, fn) \
    (LRESULT)((fn)((hwnd), GET_NCHITTEST_WPARAM(wParam), GET_XBUTTON_WPARAM(wParam), GET_X_LPARAM(lParam), GET_Y_LPARAM(lParam)), TRUE)
#define FORWARD_WM_NCXBUTTONUP(hwnd, nHitTest, fwButton, xPos, yPos, fn) \
    (void)((fn)((hwnd), WM_NCXBUTTONUP, MAKEWPARAM((nHitTest), (fwButton)), MAKELPARAM((xPos), (yPos))), 0L)
#endif
...
#define FORWARD_WM_UNINITMENUPOPUP(hwnd, hMenu, nFlags, fn) \
    (void)((fn)((hwnd), WM_UNINITMENUPOPUP, (WPARAM)(HMENU)(hMenu), (LPARAM)(UINT)(nFlags)), 0L)
#endif
...
#define HANDLE_WM_XBUTTONDOWN(hwnd, wParam, lParam, fn) \
    (LRESULT)((fn)((hwnd), FALSE, GET_KEYSTATE_WPARAM(wParam), GET_XBUTTON_WPARAM(wParam), GET_X_LPARAM(lParam), GET_Y_LPARAM(lParam)), TRUE)
#define HANDLE_WM_XBUTTONDBLCLK(hwnd, wParam, lParam, fn) \
    (LRESULT)((fn)((hwnd), TRUE, GET_KEYSTATE_WPARAM(wParam), GET_XBUTTON_WPARAM(wParam), GET_X_LPARAM(lParam), GET_Y_LPARAM(lParam)), TRUE)
#define FORWARD_WM_XBUTTONDOWN(hwnd, fDoubleClick, fwKeys, fwButton, xPos, yPos, fn) \
    (void)((fn)((hwnd), ((fDoubleClick) ? WM_XBUTTONDBLCLK : WM_XBUTTONDOWN), MAKEWPARAM((fwKeys), (fwButton)), MAKELPARAM((xPos), (yPos))), 0L)
#endif
...
#define HANDLE_WM_XBUTTONUP(hwnd, wParam, lParam, fn) \
    (LRESULT)((fn)((hwnd), GET_KEYSTATE_WPARAM(wParam), GET_XBUTTON_WPARAM(wParam), GET_X_LPARAM(lParam), GET_Y_LPARAM(lParam)), TRUE)
#define FORWARD_WM_XBUTTONUP(hwnd, fDoubleClick, fwKeys, fwButton, xPos, yPos, fn) \
    (void)((fn)((hwnd), WM_XBUTTONUP, MAKEWPARAM((fwKeys), (fwButton)), MAKELPARAM((xPos), (yPos))), 0L)
#endif
...
#define FORWARD_WM_NEXTMENU(hwnd, nCode, lpMDINextMenu, fn) \
    (void)((fn)((hwnd), WM_NEXTMENU, (WPARAM)(INT)(nCode), (LPARAM)(LPMDINEXTMENU)(lpMDINextMenu)), 0L)
#endif
...
#define FORWARD_WM_POWERBROADCAST(hwnd, nPowerEvent, nEventData, fn) \
    (LRESULT)(fn)((hwnd), WM_POWERBROADCAST, (WPARAM)(UINT)(nPowerEvent), (LPARAM)(UINT)(nEventData))
#endif
...
#define FORWARD_WM_IME_KEYDOWN(hwnd, fDown, nVirtKey, lKeyData, fn) \
    (void)((fn)((hwnd), ((BOOL)(fDown) ? WM_IME_KEYDOWN : WM_IME_KEYUP), (WPARAM)(UINT)(nVirtKey), (LPARAM)(LONG)(lKeyData)), 0L)
...
#define FORWARD_WM_MOUSEHOVER(hwnd, nFlags, xPos, yPos, fn) \
    (void)((fn)((hwnd), WM_MOUSEHOVER, (WPARAM)(UINT)(nFlags), MAKELPARAM((xPos), (yPos))), 0L)
#endif
...
#define FORWARD_WM_NCMOUSEHOVER(hwnd, nHitTest, xPos, yPos, fn) \
    (void)((fn)((hwnd), WM_NCMOUSEHOVER, (WPARAM)(UINT)(nHitTest), MAKELPARAM((xPos), (yPos))), 0L)
#endif
...
#define HANDLE_WM_APPCOMMAND(hwnd, wParam, lParam, fn) \
    (LRESULT)(BOOL)(fn)((hwnd), (HWND)(wParam), GET_APPCOMMAND_LPARAM(lParam), GET_DEVICE_LPARAM(lParam), GET_KEYSTATE_LPARAM(lParam))
#define FORWARD_WM_APPCOMMAND(hwnd, hwndTarget, cmd, nDevice, nKey, fn) \
    (BOOL)(fn)((hwnd), WM_APPCOMMAND, (WPARAM)(hwndTarget), MAKELPARAM((nKey), ((WORD)(cmd)) | (UINT)(nDevice)))
#endif
